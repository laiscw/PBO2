...
mhs1 = Mhs('Lais Cakrawati', 'Teknik Informatika', 4)
mhs2 = Mhs('Putri Robiatul A', 'Teknik Informatika', 4)
mhs3 = Mhs('Dewi Kurnia', 'Teknik Informatika', 4)
mhs_kkm = mahasiswa_kkm([mhs1, mhs2, mhs3])
Kkm = kkm('Chulalongkorn, Thailand', mhs_kkm)
